...
class CreateVideoUseCaseTest extends UseCaseTest {
    ...
    @Test
    public void givenValidCommand_whenCallsCreateVideoAndSomeCategoriesDoesNotExists_shouldReturnDomainException() {
        // given
        ...
        verify(castMemberGateway, times(1)).existsByIds(expectedMembers);
