...
public interface CategoryAPI {
    ...
    @Operation(summary = "Get a category by id it's identifier")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update a category by id it's identifier")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete a category by id it's identifier")
    @ApiResponses(value = {
