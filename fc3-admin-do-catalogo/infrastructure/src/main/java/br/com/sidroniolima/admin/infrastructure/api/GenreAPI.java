...
public interface GenreAPI {
    ...
    @Operation(summary = "Get a genre by id it's identifier")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update a genre by id it's identifier")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete a genre by id it's identifier")
    @ApiResponses(value = {
